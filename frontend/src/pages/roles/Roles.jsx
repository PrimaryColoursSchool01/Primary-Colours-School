  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 space-y-4 sm:space-y-6 animate-in fade-in duration-500">
      ...
      <div className="text-center sm:text-left space-y-2">
        ...
        <p className="text-sm text-slate-400">Fetching role configurations and permissions, please wait.</p>
      </div>

      {/* Skeleton for filter bar */}
      <div className="flex gap-3">
        <div className="h-10 flex-1 max-w-md bg-slate-200 rounded-lg animate-pulse" />
      ...
      {/* Skeleton table rows with stagger */}
        ...
        <div className="p-6 space-y-4">
          {[...Array(5)].map((_, i) => (
            <div key={i} className="flex items-center gap-4 animate-pulse" style={{ animationDelay: `${i * 100}ms` }}>
              ...
              <div className="h-6 w-28 bg-slate-200 rounded hidden md:block" />
      ...
      {/* Subtle footer note */}
      <p className="text-center text-xs text-slate-400 animate-pulse">Preparing your role management...</p>
    </div>
  );
}
